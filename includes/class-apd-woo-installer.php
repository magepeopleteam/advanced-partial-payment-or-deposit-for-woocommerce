	...
	class APD_Woo_Installer {
		...
		public function render_popup() {
			...
			$btn_text     = $is_installed
				? __( 'Activate WooCommerce', 'advanced-partial-payment-or-deposit-for-woocommerce' )
				: __( 'Install & Activate WooCommerce', 'advanced-partial-payment-or-deposit-for-woocommerce' );
			?>
			...
			<div id="apd-woo-overlay" class="apd-woo-overlay">
				<div class="apd-woo-popup">
					...
					<div class="apd-woo-header">
						...
						<span class="apd-woo-header-text"><?php esc_html_e( 'Advanced Partial Payment', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></span>
					</div>
					...
					<div class="apd-woo-content">
						<h2 class="apd-woo-title"><?php esc_html_e( 'WooCommerce Required', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></h2>
						<p class="apd-woo-desc">
							<?php esc_html_e( 'Advanced Partial Payment requires WooCommerce to manage deposits, partial payments, and installment plans. Please install and activate WooCommerce to continue using this plugin.', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?>
						</p>
					</div>
					...
					<div class="apd-woo-features">
						<div class="apd-woo-feature">
							...
							<span><?php esc_html_e( 'Deposit & partial payments', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></span>
						</div>
						<div class="apd-woo-feature">
							<span class="apd-woo-feature-icon">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M13.3 4.3L6 11.6 2.7 8.3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
							</span>
							<span><?php esc_html_e( 'Installment schedules', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></span>
						</div>
						<div class="apd-woo-feature">
							<span class="apd-woo-feature-icon">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M13.3 4.3L6 11.6 2.7 8.3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
							</span>
							<span><?php esc_html_e( 'Order management', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></span>
						</div>
					</div>
					...
					<div class="apd-woo-actions">
						...
						<a href="<?php echo esc_url( admin_url( 'plugin-install.php?s=woocommerce&tab=search&type=term' ) ); ?>" class="apd-woo-btn apd-woo-btn-secondary">
							<?php esc_html_e( 'Install Manually', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?>
						</a>
					</div>
					...
					<p class="apd-woo-footer-note">
						...
						<?php esc_html_e( 'WooCommerce is free, open-source, and trusted by millions of stores worldwide.', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?>
					</p>
				</div>
			</div>
			<?php
		...
		public function ajax_install_woocommerce() {
			...
			if ( ! current_user_can( 'install_plugins' ) ) {
				wp_send_json_error( array( 'message' => __( 'You do not have permission to install plugins.', 'advanced-partial-payment-or-deposit-for-woocommerce' ) ) );
			}
			...
			if ( $result === false ) {
				wp_send_json_error( array( 'message' => __( 'Installation failed.', 'advanced-partial-payment-or-deposit-for-woocommerce' ) ) );
			}

			wp_send_json_success( array( 'message' => __( 'WooCommerce installed successfully.', 'advanced-partial-payment-or-deposit-for-woocommerce' ) ) );
		}
		...
		public function ajax_activate_woocommerce() {
			...
			if ( ! current_user_can( 'activate_plugins' ) ) {
				wp_send_json_error( array( 'message' => __( 'You do not have permission to activate plugins.', 'advanced-partial-payment-or-deposit-for-woocommerce' ) ) );
			}
			...
			wp_send_json_success( array( 'message' => __( 'WooCommerce activated successfully!', 'advanced-partial-payment-or-deposit-for-woocommerce' ) ) );
		}
	}
