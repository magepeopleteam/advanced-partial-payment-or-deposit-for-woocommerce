...
class APD_Activator {
    ...
    private static function create_default_options() {
        $defaults = array(
            ...
            'force_deposit'        => 'no',
            'deposit_label'        => __( 'Deposit', 'advanced-partial-payment-or-deposit-for-woocommerce' ),
            'due_balance_label'    => __( 'Due Balance', 'advanced-partial-payment-or-deposit-for-woocommerce' ),
            'pay_button_label'     => __( 'Pay Remaining Balance', 'advanced-partial-payment-or-deposit-for-woocommerce' ),
            'deposit_text'         => __( 'Pay a deposit of {deposit_amount}', 'advanced-partial-payment-or-deposit-for-woocommerce' ),
            'full_payment_text'    => __( 'Pay full amount of {full_amount}', 'advanced-partial-payment-or-deposit-for-woocommerce' ),
