...
<form class="apd-settings-form" data-tab="general">
	...
	<div class="apd-card">
		...
		<div class="apd-card-body">
			<div class="apd-field-row">
				<div class="apd-field-label">
					<label for="apd-delete-data-on-uninstall"><?php esc_html_e( 'Delete Data on Uninstall', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></label>
					<p class="apd-field-desc"><?php esc_html_e( 'When enabled, deleting this plugin also removes its settings and every deposit setting stored on products, categories and orders. Leave off to keep that data in case the plugin is reinstalled.', 'advanced-partial-payment-or-deposit-for-woocommerce' ); ?></p>
				</div>
				<div class="apd-field-input">
					<label class="apd-toggle">
						<input type="checkbox" name="delete_data_on_uninstall" id="apd-delete-data-on-uninstall"
								value="yes" <?php checked( $settings['delete_data_on_uninstall'] ?? 'no', 'yes' ); ?> />
						<span class="apd-toggle-slider"></span>
					</label>
				</div>
			</div>
