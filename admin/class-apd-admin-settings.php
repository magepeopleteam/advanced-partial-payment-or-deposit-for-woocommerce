...
class APD_Admin_Settings {
	...
	public function save_settings() {
		...
		switch ( $tab ) {
			...
			case 'labels':
				$settings['deposit_label']     = sanitize_text_field( wp_unslash( $_POST['deposit_label'] ?? '' ) );
				$settings['due_balance_label'] = sanitize_text_field( wp_unslash( $_POST['due_balance_label'] ?? '' ) );
				$settings['pay_button_label']  = sanitize_text_field( wp_unslash( $_POST['pay_button_label'] ?? '' ) );
				$settings['deposit_text']      = sanitize_text_field( wp_unslash( $_POST['deposit_text'] ?? '' ) );
				$settings['full_payment_text'] = sanitize_text_field( wp_unslash( $_POST['full_payment_text'] ?? '' ) );
				break;
	...
	public function save_category_deposit() {
		...
		$enable       = sanitize_text_field( wp_unslash( $_POST['enable_deposit'] ?? 'no' ) );
		$force        = sanitize_text_field( wp_unslash( $_POST['force_deposit'] ?? '' ) );
		$deposit_type = sanitize_text_field( wp_unslash( $_POST['deposit_type'] ?? 'percentage' ) );
