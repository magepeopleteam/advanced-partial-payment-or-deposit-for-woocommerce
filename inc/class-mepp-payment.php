...
class MEPP_Payment extends WC_Order
{
    ...
    {
        return apply_filters('mepp_is_mepp_payment_editable',false,$this->get_id());
    }
    ...
    public function get_order_item_totals($tax_display = '')
    {
        ...
        if($this->get_meta('_mepp_partial_payment_itemized') === 'yes'){
